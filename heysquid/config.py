...
_pkg_dir = Path(__file__).resolve().parent          # heysquid/
_candidate_root = _pkg_dir.parent                   # parent of heysquid/
...
def get_template_path(name: str) -> str:
    ...
    return str(_pkg_dir / "templates" / name)
